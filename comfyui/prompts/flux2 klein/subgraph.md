# 一个非常好的subgraph例子
https://www.reddit.com/r/comfyui/comments/1qim6km/complete_flux2_klein_workflow/
![image](../../images/3-subgraph-example.png)
```
{
  "id": "9ba0f51a-053b-41e1-8b9e-11f1053fe11e",
  "revision": 0,
  "last_node_id": 61,
  "last_link_id": 73,
  "nodes": [
    ...
    {
      "id": 28,
      "type": "2f700dd1-b104-4e63-be65-3a07b62af85b",
      "pos": [
        2106.8255316609384,
        636.0959204684036
      ],
      ...
      "widgets_values": [
        "A man and a robot doing a Yoga Pose",
        "Image\\flux-2-klein-9b-fp8.safetensors",
        "qwen_3_8b_fp8mixed.safetensors",
        "flux2-vae.safetensors",
        "F:\\Programs\\ComfyUI-Easy-Install\\ComfyUI\\input\\Iterator",
        "2\n3\n6"
      ]
    },
    {
    ...
    },
    {
      ...
      "widgets_values": [
        "F:\\Programs\\ComfyUI-Easy-Install\\ComfyUI\\input\\Referencias"
      ]
    },
    {
      "id": 56,
  ...
  "definitions": {
    "subgraphs": [
      {
        "id": "c78cad7b-4c48-47f8-a0ef-65c69cf19a00",
        "version": 1,
        "state": {
          "lastGroupId": 4,
          "lastNodeId": 78,
      ...
      {
        "id": "2f700dd1-b104-4e63-be65-3a07b62af85b",
        "version": 1,
        "state": {
          "lastGroupId": 4,
          "lastNodeId": 70,
        ...
        "inputs": [
          {
            "id": "edfa9cf0-cee6-49e7-a158-b9ffd34656c3",
            "name": "text",
            "type": "STRING",
            "linkIds": [
              32
          ...
          {
            "id": "1b081bcf-cdff-4daf-9ac2-af6c1ba945aa",
            "name": "unet_name",
            "type": "COMBO",
            "linkIds": [
              34
          ...
          {
            "id": "b8482194-f76e-472e-b5cd-8406a3bc1469",
            "name": "clip_name",
            "type": "COMBO",
            "linkIds": [
              35
          ...
          {
            "id": "4239b2d8-588c-4c2a-93f4-2f45e84e681c",
            "name": "vae_name",
            "type": "COMBO",
            "linkIds": [
              36
          ...
          {
            "id": "90158521-7cf7-4d65-9d91-acbef2be4e21",
            "name": "image",
            "type": "IMAGE",
            "linkIds": [
              85
          ...
          {
            "id": "e1d144c9-5904-4cb6-b440-f9152fe874d3",
            "name": "directory",
            "type": "STRING",
            "linkIds": [
              79
          ...
          {
            "id": "3642bcf9-0e7b-49de-b40c-d98afd616cf0",
            "name": "on_true",
            "type": "*",
            "linkIds": [
              84
          ...
          {
            "id": "89a5e151-5257-480f-ae27-d6bb02340ef0",
            "name": "string",
            "type": "STRING",
            "linkIds": [
              90
        ...
        "outputs": [
          {
            "id": "d4d8a4a4-7b79-4156-8331-08af76f76f08",
            "name": "IMAGE",
            "type": "IMAGE",
            "linkIds": [
              38
        ...
        "nodes": [
          ...
          {
            "id": 24,
            "type": "c78cad7b-4c48-47f8-a0ef-65c69cf19a00",
            "pos": [
              1599.286741219438,
              736.4103941509858
            ],
          ...
          {
            "id": 49,
            "type": "f030b643-c1b0-44ba-9d86-6c497178db7d",
            "pos": [
              1631.744831552173,
              991.3118953840735
            ],
      ...
      {
        "id": "f030b643-c1b0-44ba-9d86-6c497178db7d",
        "version": 1,
        "state": {
          "lastGroupId": 4,
          "lastNodeId": 78,
